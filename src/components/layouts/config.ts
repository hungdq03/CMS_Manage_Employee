...
export const navItems = [
  ...
  { key: 'manager', title: 'Quản lý', icon: 'manager', 
    children: [
      { key: 'add', title: 'Thêm nhân viên', href: paths.dashboard.manager.add },
      { key: 'manage', title: 'Quản lý nhân viên', href: paths.dashboard.manager.manage },
      { key: 'fired', title: 'Kết thúc nhân viên', href: paths.dashboard.manager.fired },
